...
//------------------------------------------------------------------------------
void bmp280_getCalib(void)
{
  dig_T1 = bmp280_read16(dig_T1_REG);
	dig_T2 = bmp280_read16(dig_T2_REG);
	dig_T3 = bmp280_read16(dig_T3_REG);
	dig_P1 = bmp280_read16(dig_P1_REG);
	dig_P2 = bmp280_read16(dig_P2_REG);
	dig_P3 = bmp280_read16(dig_P3_REG);
	dig_P4 = bmp280_read16(dig_P4_REG);
	dig_P5 = bmp280_read16(dig_P5_REG);
	dig_P6 = bmp280_read16(dig_P6_REG);
	dig_P7 = bmp280_read16(dig_P7_REG);
	dig_P8 = bmp280_read16(dig_P8_REG);
	dig_P9 = bmp280_read16(dig_P9_REG);
}
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
uint8_t bmp280_read8(uint8_t regAddress)
{
	uint8_t result = 0;
...
//------------------------------------------------------------------------------
int16_t bmp280_read16(uint8_t regAddress)
{
	uint8_t data[2];

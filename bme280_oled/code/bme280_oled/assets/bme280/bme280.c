...
//------------------------------------------------------------------------------
uint8_t bme280_read8(uint8_t regAddress)
{
	uint8_t result = 0;
...
//------------------------------------------------------------------------------
int16_t bme280_read16(uint8_t regAddress)
{
	uint8_t data[2];
...
//------------------------------------------------------------------------------
float bme280_getHum(calib_coefs calib)
{
  int32_t v_x1_u32r;
  uint32_t humdity;
...
//------------------------------------------------------------------------------
void bme280_getCalib(calib_coefs *calib)
{

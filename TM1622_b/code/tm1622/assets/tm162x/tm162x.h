...
#define DECIMAL_POINT           0x8000
//-----------------------------------------------------------------------------------
void tm162x_init(void);
void tm162x_command(uint8_t command);
void tm162x_data(uint8_t reg, uint8_t sdata);
...
//-----------------------------------------------------------------------------------
//                            Character nibble addresses
//                                     39,       35,       31,       27,       23,       19,       15,       11,        7,        3 
const uint8_t nibbleAddr[10] = { 0x27, 0x23, 0x1F, 0x1B, 0x17, 0x13, 0x0F, 0x0B, 0x07, 0x03 };
//-----------------------------------------------------------------------------------
#endif